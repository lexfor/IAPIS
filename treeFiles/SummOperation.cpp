...
#include "SummOperation.h"
bool SummOperation::ParseOperation(std::vector<std::string> tok) {
...
bool SummOperation::checkOperation() {
    return true;
}

void SummOperation::ToString(std::string & str) {
    str += operands[0];
    str += " ";
    str += operat[0];
    str += " ";
