...
bool DivOperation::ParseOperation(std::vector<std::string> tok) {
...
bool DivOperation::checkOperation() {
    return true;
}

void DivOperation::ToString(std::string & str) {
    str += operands[0];
    str += " ";
    str += operat[0];
    str += " ";
